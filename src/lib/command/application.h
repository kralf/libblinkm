...
namespace BlinkM {
  namespace Command {
    ...
    public:
      ...
      /** Construct a BlinkM commandline application
        */
      Application(const std::string& description);
      Application(const Application& src);

      /** Destroy a BlinkM commandline application
        */
      virtual ~Application();

      /** BlinkM commandline application assignments
        */
      ...
      /** Add an argument to the BlinkM commandline application
        */
